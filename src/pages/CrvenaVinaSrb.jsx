...
import { CrvenaVinaSrbije } from '../Services/meni'
import { motion } from 'framer-motion'
function CrvenaVinaSrb() {
    ...
    return (
        ...
        >
            <div className='lg:border-4 border-white border-4 rounded-t-2xl bg-mis'>
                <h1 className='text-white font-link text-3xl m-10'>CRVENA VINA SRBIJE</h1>
                <hr className='text-white border-2 m-4' />
                <div className=''>
                    {CrvenaVinaSrbije.map((meni, index) => {
                        return (
