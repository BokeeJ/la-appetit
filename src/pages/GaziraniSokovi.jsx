...
import { gaziraniSokovi } from '../Services/meni'
import { motion } from 'framer-motion'
function GaziraniSokovi() {
    ...
    return (
        ...
        >
            <div className='lg:border-4 border-white border-4 rounded-t-2xl bg-mis'>
                <h1 className='text-white font-link text-3xl m-10'>Gazirani sokovi</h1>
                <hr className='text-white border-2 m-4' />
                <div className=''>
                    {gaziraniSokovi.map((meni, index) => {
                        return (
