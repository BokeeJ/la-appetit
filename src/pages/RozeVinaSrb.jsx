...
import { roseVinaSrbije } from '../Services/meni'
import { motion } from 'framer-motion'
function RozeVinaSrb() {
    ...
    return (
        ...
        >
            <div className='lg:border-4 border-white border-4 rounded-t-2xl bg-mis'>
                <h1 className='text-white font-link text-3xl m-10'>ROSE VINA SRBIJE</h1>
                <hr className='text-white border-2 m-4' />
                <div className=''>
                    {roseVinaSrbije.map((meni, index) => {
                        return (
