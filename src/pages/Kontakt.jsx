    ...
    return (
        <div className='w-full md:h-[40%] md:p-0 p-5'>
            ...
            <div className='w-full flex lg:flex-row md:flex-row flex-col p-5'>
                <img className='w-[500px] lg:mt-11 rounded-2xl md:mt-[90px] h-[610px]' src="/proslave.jpg" alt="" />
                <div className='flex flex-col h-full gap-5 items-center'>
                    ...
                    <img className='w-[400px] rounded-2xl md:h-[400px] h-[600px]' src="/enterijer2.jpeg" alt="" />
                </div>
            </div>
