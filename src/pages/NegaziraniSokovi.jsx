...
import { negaziraniSokovi } from '../Services/meni'
import { motion } from 'framer-motion'
function NegaziraniSokovi() {
    ...
    return (
        ...
        >
            <div className='lg:border-4 border-white border-4 rounded-t-2xl bg-mis'>
                <h1 className='text-white font-link text-3xl m-10'>NEGAZIRANI SOKOVI</h1>
                <hr className='text-white border-2 m-4' />
                <div className=''>
                    {negaziraniSokovi.map((meni, index) => {
                        return (
...
export default NegaziraniSokovi